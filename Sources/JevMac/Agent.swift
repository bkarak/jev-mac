...
public protocol JevMacError: Error, CustomStringConvertible {}

public struct PredictionError: JevMacError {
...
public final class Agent: Sendable {
    ...
    public static func explain(_ error: Error) -> String {
        ...
        if let e = error as? any JevMacError { return e.description }
